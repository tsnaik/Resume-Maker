...
<p>To set the \'directionality\' of the whole document e.g. to reverse default alignment, tables, lists etc. you can set the output attribute or the direction CSS property on the HTML or BODY tag to \'rtl\' e.g.</p>
...
- base direction can be set by any of:
	...
	- &lt;html output="rtl" or style="direction: rtl;"&gt;
	- &lt;body output="rtl" or style="direction: rtl;"&gt;
...
- language (either CSS "lang", using Autofont, or through initial set-up e.g. $mpdf = new mPDF(\'ar\') ) 
	...
	- config_cp.php has been changed as a result; any values of "output" set here are now ineffective
